...
contract ExtendMarket is BaseMarket {
   ...
   // proxyMinter ==  revenueRecipient
    function NewNFTByRevenueRecipient(string memory _tokenURI, uint256 _royalty) external _lock_ returns(uint256)
    {
        require(_royalty < 30, "Excessive copyright fees");
        require(proxyMinter ==  revenueRecipient, "The Minting Proxy is not the same as RevenueRecipient");
